...
public class TelaVitoria implements Screen {
    ...
    public TelaVitoria(GameRunner gameRunner) {
    ...
    private void limparTela() {
        Gdx.gl.glClearColor(0.1f, 0.6f, 0.3f, 1);
    ...
    private void desenharMensagem() {
        ...
        gameRunner.font.draw(gameRunner.batch, "Parabéns! Você venceu!", centroX - 100, centroY + 20);
        gameRunner.font.draw(gameRunner.batch, "Pressione ENTER para jogar novamente", centroX - 160, centroY - 20);
